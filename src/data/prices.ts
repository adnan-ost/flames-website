...
export const PRICES: Record<string, DishPrice> = {
  ...
  "Chicken Boti": { amount: 2725, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.20 — Chicken Boti 8 pcs (boneless), half, Rs 2595 plus 5% = Rs 2725." },
  "Chicken Malai Boti": { amount: 2725, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.20 — Chicken Malai Tikka 8 pcs, half, Rs 2595 plus 5% = Rs 2725." },
  "Chicken Seekh Kebab": { amount: 1810, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.20 — Chicken Seekh Kebab 2 pcs, half, Rs 1725 plus 5% = Rs 1810." },
  "Chicken Cheese Boti": { amount: 2725, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.20 — Chicken Cheese Tikka 6 pcs, half, Rs 2595 plus 5% = Rs 2725." },
  ...
  "Green Chicken Chilli Boti": { amount: 2725, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.20 — Chicken Green Boti 8 pcs (boneless), half, Rs 2595 plus 5% = Rs 2725." },
  "Reshmi Kebab": { amount: 2725, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.20 — Chicken Reshami Tikka 8 pcs, half, Rs 2595 plus 5% = Rs 2725." },
  ...
  /* ----- Mutton & Beef BBQ ----- */
  "Mutton Seekh Kebab": { amount: 2830, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.20 — Mutton Seekh Kebab 2 pcs, half, Rs 2695 plus 5% = Rs 2830." },
  ...
  "Beef Seekh Kebab": { amount: 2095, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.20 — Beef Seekh Kebab 6 pcs, half, Rs 1995 plus 5% = Rs 2095." },
  "Bihari Kebab": { amount: 2935, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.20 — Beef Behari Kebab 6 pcs, half, Rs 2795 plus 5% = Rs 2935." },
  "Behari Boti": { amount: 2935, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.20 — Beef Behari Kebab 6 pcs, half, Rs 2795 plus 5% = Rs 2935." },
  "Gola Kebab": { amount: 2145, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.20 — Chicken Gola Kebab 8 pcs, half, Rs 2045 plus 5% = Rs 2145." },
  "Chapli Kebab": { amount: 1305, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.25 — Special Peshawari Chapli Kebab 2 pcs, half, Rs 1245 plus 5% = Rs 1305." },

  /* ----- From the Sea ----- */
  "Fish Tikka": { amount: 3405, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.20 — Fish Tikka 8 pcs, half, Rs 3245 plus 5% = Rs 3405." },
  "Palla Fish": { amount: 2705, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Inferred from comparable Islamabad menu p.18 Lahori Fried Fish 6 pcs, Rs 2575 plus 5% = Rs 2705." },

  /* ----- Chicken Karahi ----- */
  "Chicken Karahi": { amount: 2355, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.18 — Chicken Karahi (with bone), half, Rs 2245 plus 5% = Rs 2355." },
  "Chicken White Karahi": { amount: 2565, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.25 — Peshawari Chicken Karahi (boneless), half, Rs 2445 plus 5% = Rs 2565." },
  "Chicken Shinwari Karahi": { amount: 2250, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.25 — Peshawari Chicken Karahi (with bone), half, Rs 2145 plus 5% = Rs 2250." },
  "Chicken Achari Karahi": { amount: 2620, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.18 — Chicken Achari (with bone), half, Rs 2495 plus 5% = Rs 2620." },
  "Chicken Smoke Karahi": { amount: 2620, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Inferred from comparable Islamabad menu p.18 chicken karahi band, Rs 2495 plus 5% = Rs 2620." },

  /* ----- Mutton Karahi ----- */
  "Mutton Karahi": { amount: 4280, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.18 — Mutton Karahi (with bone), half, Rs 4075 plus 5% = Rs 4280." },
  "Mutton Shinwari": { amount: 3825, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.25 — Namkeen Dumba Karahi (with bone), half, Rs 3645 plus 5% = Rs 3825." },
  "Mutton Smoke Karahi": { amount: 4350, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Inferred from comparable Islamabad menu p.18 mutton karahi band, Rs 4145 plus 5% = Rs 4350." },
  "Namkeen Gosht": { amount: 3825, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.25 — Namkeen Dumba Karahi (with bone), half, Rs 3645 plus 5% = Rs 3825." },

  /* ----- Boneless Handi ----- */
  "Chicken Boneless Handi": { amount: 3090, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.18 — Chicken Handi (boneless), half, Rs 2945 plus 5% = Rs 3090." },
  "Chicken White Makhani Handi": { amount: 3090, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.18 — Chicken Makhni (boneless), half, Rs 2945 plus 5% = Rs 3090." },
  "Chicken Achari Handi": { amount: 3090, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.18 — Chicken Achari (boneless), half, Rs 2945 plus 5% = Rs 3090." },
  "Chicken Jalfrezi Handi": { amount: 3090, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.18 — Chicken Jalfrezi (boneless), half, Rs 2945 plus 5% = Rs 3090." },
  "Chicken Green Chilli Handi": { amount: 3145, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.18 — Chicken Green Chilli with Lemon (boneless), half, Rs 2995 plus 5% = Rs 3145." },
  "Chicken Ginger Handi": { amount: 3090, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.18 — Chicken Ginger (boneless), half, Rs 2945 plus 5% = Rs 3090." },

  /* ----- Signature Chicken Curries ----- */
  "Chicken Korma": { amount: 3090, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Inferred from comparable Islamabad menu p.18 boneless handi band, Rs 2945 plus 5% = Rs 3090." },
  "Chicken Makhani": { amount: 3090, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Comparable Islamabad menu p.18 — Chicken Makhni (boneless), half, Rs 2945 plus 5% = Rs 3090." },

  /* ----- Slow Cooked Mutton — no comparable entries ----- */
  "Mutton Qorma": { amount: 5190, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Inferred from comparable Islamabad menu p.18 Mutton Handi (boneless), half, Rs 4945 plus 5% = Rs 5190." },
  "Mutton White Qorma": { amount: 5190, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Inferred from comparable Islamabad menu p.18 Mutton Handi (boneless), half, Rs 4945 plus 5% = Rs 5190." },
  "Aloo Gosht": { amount: 4280, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Inferred from comparable Islamabad menu p.18 Mutton Karahi (with bone), half, Rs 4075 plus 5% = Rs 4280." },
  "Rogan Josh": { amount: 5190, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Inferred from comparable Islamabad menu p.18 mutton handi band, Rs 4945 plus 5% = Rs 5190." },
  "Yakhni": { amount: 4280, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Inferred from comparable Islamabad menu p.18 mutton karahi band, Rs 4075 plus 5% = Rs 4280." },
  "Gushtaba": { amount: 5190, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Inferred from comparable Islamabad menu p.18 mutton handi band, Rs 4945 plus 5% = Rs 5190." },
  "Tabak Maaz": { amount: 5190, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Inferred from comparable Islamabad menu p.18 mutton handi band, Rs 4945 plus 5% = Rs 5190." },
  "Seyal Gosht": { amount: 5190, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Inferred from comparable Islamabad menu p.18 mutton handi band, Rs 4945 plus 5% = Rs 5190." },
  "Dampukht": { amount: 5190, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Inferred from comparable Islamabad menu p.18 mutton handi band, Rs 4945 plus 5% = Rs 5190." },
  "Balochi Rosh": { amount: 5190, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Inferred from comparable Islamabad menu p.18 mutton handi band, Rs 4945 plus 5% = Rs 5190." },
  "Landhi": { amount: 5190, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Inferred from comparable Islamabad menu p.18 mutton handi band, Rs 4945 plus 5% = Rs 5190." },

  /* ----- Beef Curries ----- */
  "Beef Korma": { amount: 2620, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Inferred from comparable Islamabad menu p.18 Beef Seekh Kebab Masala, Rs 2495 plus 5% = Rs 2620." },
  "Aloo Gosht (Beef)": { amount: 2565, status: "confirmed", source: "Confirmed by the owner, 25 Aug 2026. Derived from: Inferred from comparable Islamabad menu p.25 Beef Tikka Masala Karahi, Rs 2445 plus 5% = Rs 2565." },
