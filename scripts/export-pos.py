"""
Fill the Blink POS import workbook from the live menu.

    python3 scripts/export-pos.py "Blink POS Data/Blink POS Data.xlsx"
...
def main():
    ...
    ref.append(["category_id", "category_name", "website_filter"])
    for c in categories:
        ref.append(c)
